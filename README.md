...
macOS launcher requires Python 3.10 or newer. On Windows, an existing compatible
Python is reused; otherwise, the launcher installs Python 3.12 for the current
user using Windows Package Manager or the signed installer from python.org.
